...
class WizardStockRequestOrderKanban(models.TransientModel):
    ...
    def validate_kanban(self, barcode):
        res = super(WizardStockRequestOrderKanban,self).validate_kanban(barcode)
    ...
    def stock_request_kanban_values(self):
        res = super(WizardStockRequestOrderKanban,self).stock_request_kanban_values()
    ...
    def barcode_ending(self):
        super(WizardStockRequestOrderKanban,self).barcode_ending()
