...
class PurchaseOrder(models.Model):
    ...
    stock_request_ids = fields.Many2many(comodel_name='stock.request',string='Stock Requests',compute='_compute_stock_request_ids')
    ...
    def _compute_stock_request_ids(self):
        for rec in self:
            ...
            # print("==================PO====== in _compute_stock_request_ids===========",rec.stock_request_ids)
