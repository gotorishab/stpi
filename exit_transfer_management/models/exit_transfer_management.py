...
class ExitTransferManagement(models.Model):
    ...
    def button_verify(self):
        ...
        #             "letter_no": res.id,
        #             "sender_type_id": res.sender_type_id.id,
        #             "file_assign_id": res.file_assign_id.id,
        #         })
        #
        # my_file_ids = self.env['folder.master'].search([("employee_id", "=", self.employee_id.id), ])
        #
        # if my_file_ids:
