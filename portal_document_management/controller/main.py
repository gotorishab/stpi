...
class DocumentData(CustomerPortal):
    ...
    def _prepare_portal_layout_values(self):
        ...
        documents_count = request.env['portal.documents'].sudo().search_count([('is_published', '=', True)])
        values['documents_count'] = documents_count
        values['page_name'] = 'documents'
        return values

    @http.route(['/get/documents', '/get/documents/page/<int:page>'], type='http', auth="user", website=True)
