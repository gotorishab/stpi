...
class ExceptionRule(models.Model):
    ...
    rule_group = fields.Selection(
        selection_add=[('appraisal_main','Appraisal Line Manager'),
                       ],
    )
...
class Appraisal(models.Model):
    ...
    def button_line_manager_reviewed(self):
        if self.detect_exceptions():
            ...
            return super(Appraisal, self).button_line_manager_reviewed()

    @api.model
    def _get_popup_action(self):
        action = self.env.ref('hr_exception.action_appraisal_main_confirm')
        return action
    ...
    def button_reject(self):
        ...
        return super(Appraisal, self).button_reject()
    ...
    def approve(self):
        ...
        if res:
            ...
            if self.model_id.model == 'appraisal.main':
                self.resource_ref.button_line_manager_reviewed()
        return res
