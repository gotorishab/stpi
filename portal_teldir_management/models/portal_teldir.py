...
class Portalteldirs(models.Model):
    _name = 'portal.teldirs'
    _inherit = ['mail.thread', 'mail.activity.mixin']
    _description = 'Portal teldirs'

    name = fields.Char(string='Name', track_visibility='always')
    type_id = fields.Many2one('teldirs.type',string='Type', track_visibility='always')
    teldir = fields.Binary(string='teldir',attachment=True, track_visibility='always')
    ...
    def _get_image(self):
        image_base64 = base64.b64decode(self.teldir)
...
class teldirsType(models.Model):
    _name = 'teldirs.type'
