    ...
    def confirm_button(self):
        if self:
            ...
            dd = self.env['dispatch.document'].create({
                ...
                'current_user_id': str(current_employee.user_id.id),
                'department_id': str(current_employee.department_id.id),
                'job_id': str(current_employee.job_id.id),
                'branch_id': str(current_employee.branch_id.id),
