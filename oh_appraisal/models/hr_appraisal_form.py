...
class HrAppraisalForm(models.Model):
    ...
    emp_id = fields.Many2one('hr.employee', required=True)
    ...
    hr_emp = fields.Boolean (default=False)
    ...
    hr_manager_id = fields.Many2many('hr.employee', 'manager_appraisal_rel')
    ...
    colloborator_survey_id = fields.Many2one('survey.survey')
